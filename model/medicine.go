...
type Medicine struct {
	...
	Category       *Category     `gorm:"foreignKey:CategoryID;column:category" json:"category,omitempty"`
	ManufacturerID *uint         `gorm:"column:manufacturer_id" json:"manufacturer_id"`
	Manufacturer   *Manufacturer `gorm:"foreignKey:ManufacturerID;column:manufacturer" json:"manufacturer,omitempty"`
